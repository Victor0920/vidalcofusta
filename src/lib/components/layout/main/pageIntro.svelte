<script lang="ts">
	export let imageUrl: string, imageDescription: string, title: string, subtitle: string;
</script>

<div
	class="w-screen h-[300px] top-0 left-0 flex flex-col justify-center items-center relative -z-10"
>
	<img
		src={imageUrl}
